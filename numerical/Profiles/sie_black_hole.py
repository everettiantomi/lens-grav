...
class SIEBH(LensProfileBase):
    ...
    def function(self, x, y, theta_E, eta, theta_E_1, x1, y1, center_x=0, center_y=0):
        ...
        phi = theta_E*r*np.sqrt(1.-eta*np.cos(2.*theta)) +  theta_E_1**2*np.log(r1)
        return phi

    def derivatives(self, x, y, theta_E, eta, theta_E_1, x1, y1, center_x=0, center_y=0):
        """
    ...
    def hessian(self, x, y, theta_E, eta, theta_E_1, x1, y1, center_x=0, center_y=0):
        """
